...
var NumberParser = /** @class */ (function () {
    function NumberParser() {
        this.trueMatcher = /yes|ok|on|enable|true/i;
        this.falseMatcher = /no|off|disable|false/i;
    }
    NumberParser.prototype.parse = function (message, input) {
        if (this.trueMatcher.test(input))
            return true;
        if (this.falseMatcher.test(input))
            return false;
        return null;
    };
    NumberParser = __decorate([
        nestcord_decorator_1.NestCord.Parser("Boolean")
    ], NumberParser);
    return NumberParser;
}());
